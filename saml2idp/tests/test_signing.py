...
from . import override_settings_file, override_settings_str
...
class TestSigning:
    def test1(self):
        signature_xml = get_signature_xml(
            settings.SAML2IDP_CONFIG, 'this is a test', 'abcd' * 10)
...
class TestSigningWithFile(TestSigning, XmlTest):
    pass


@override_settings_str
class TestSigningWithStr(TestSigning, XmlTest):
    pass


class TestAssertionSalesForce:
    ...
    def test_assertion_rendering(self):
        ...
        params.update(REQUEST_PARAMS)
        params.update(ASSERTION_SALESFORCE_PARAMS)
        got = xml_render.get_assertion_salesforce_xml(
            settings.SAML2IDP_CONFIG, params, signed=False)
    ...
    def test_signed_assertion(self):
        ...
        params.update(ASSERTION_SALESFORCE_PARAMS)
        got = xml_render.get_assertion_salesforce_xml(
            settings.SAML2IDP_CONFIG, params, signed=True)
        self._test(got, SIGNED_ASSERTION_SALESFORCE_XML)


@override_settings_file
class TestAssertionSalesForceWithFile(TestSigning, XmlTest):
    pass


@override_settings_str
class TestAssertionSalesForceWithStr(TestSigning, XmlTest):
    pass
...
@override_settings_file
class TestResponseWithFile(TestSigning, XmlTest):
    pass


@override_settings_str
class TestResponseWithStr(TestSigning, XmlTest):
    pass
